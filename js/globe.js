(function() {
  ...
  var colors = ['#EC4D4A', '#F18038', '#68E1FB', '#97E679', '#F5D94A', '#FF89D6']
  ...
  //    var color = colors[Math.floor(Math.random() * colors.length)];
  //    globe.plugins.pings.add(-122, 37, { color: "#000000", ttl: 2000, angle: Math.random() * 10 });
  //    globe.plugins.pings.add(122, 37, { color: "#ffffff", ttl: 2000, angle: Math.random() * 10 });
  //  }, 500);
